/*
  # Add GST and TDS fields to invoices table
  
  1. New Columns
    - `is_gst_registered` (boolean): Flag to indicate if GST is applicable
    - `gstin` (text): GST Identification Number 
    - `gst_rate` (numeric): GST rate percentage
    - `is_tds_applicable` (boolean): Flag to indicate if TDS is applicable
    - `tds_rate` (numeric): TDS rate percentage
    
  2. Changes
    - Makes these fields optional to ensure compatibility with existing invoices
    - Ensures invoice creation works properly with or without tax settings
*/
