...
const EditEmployee = () => {
  ...
  const { selectedEmployee, fetchEmployee, updateEmployee, loading } = useEmployeeStore();
  ...
  useEffect(() => {
    if (selectedEmployee) {
      reset({
        ...
        hourly_rate: selectedEmployee.hourly_rate || undefined,
        monthly_salary: selectedEmployee.monthly_salary || undefined,
        join_date: selectedEmployee.join_date || '',
        status: selectedEmployee.status || 'active',
        notes: selectedEmployee.notes || '',
        currency_preference: selectedEmployee.currency_preference || 'INR'
      });
    }
